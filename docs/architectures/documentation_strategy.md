# Documentation Strategy for Optional Requirements

This document outlines the strategy for documenting and managing optional functional and non-functional requirements within the Overknight project.
